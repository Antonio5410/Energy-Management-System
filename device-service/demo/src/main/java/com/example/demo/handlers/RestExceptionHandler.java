...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ExceptionHandlerResponseDTO> handleDuplicateResourceException(DuplicateResourceException ex) {
        ExceptionHandlerResponseDTO response = new ExceptionHandlerResponseDTO(
                "Conflict",
                ex.getMessage()
        );
